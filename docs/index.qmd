...
On the basis of these text inputs, either the same enumerators, or clerical coders following receipt of the data, are expected to assign at least one suitable class from a coding scheme (e.g. [ISCO-08](https://ilostat.ilo.org/methods/concepts-and-definitions/classification-occupation/)) which best fits the given description. Such coding schemes are set up to link job descriptions to a range of standardised classes, each with a numeric code. Such schemes allow for consistent statistical reporting, and provide a means of international comparability. [ISCO-08 is the international standard](https://ilostat.ilo.org/methods/concepts-and-definitions/classification-occupation/) for this, but many countries use bespoke coding schemes that are partly or wholly based on ISCO (for example, the UK uses a national scheme called [SOC](https://www.ons.gov.uk/methodology/classificationsandstandards/standardoccupationalclassificationsoc), whereas the Namibian scheme is referred to as [NASCO](file:///home/jejoenje/Downloads/Code%20list%20NLFS%202014%20Correct%20(3).pdf)).  
